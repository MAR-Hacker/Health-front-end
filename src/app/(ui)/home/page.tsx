...
export default function DoctorsPage() {
  ...
  useEffect(() => {
    const fetchDoctors = async () => {
      ...
      try {
        const response = await axios.get('https://health-backend-m8l5.onrender.com/doctors/getAll');
              ...
              <div className="p-6">
                <div className="flex items-center mb-4">
                  <img
                    ...
                    onError={(e) => {
                      e.currentTarget.src = "https://randomuser.me/api/portraits/lego/5.jpg";
                    }}
                  />
                  <div>
                ...
                <div className="mb-2">
                  ...
                  <span className="text-sm text-black font-medium">{doctor.experience} years</span>
                </div>
